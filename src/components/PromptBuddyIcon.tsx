...
const IconSvg: FC<IconSvgProps> = ({ className = 'prompt-buddy-svg' }) => (
  ...
  >
    ...
    <path
      ...
      fill="url(#prompt-buddy-gradient)"
    />
    <path
...
const PromptBuddyIcon: FC = () => {
  ...
  return (
    <Tooltip
      trigger="hover"
      placement="left"
      title="Press Ctrl+Space to open the prompt buddy window"
      zIndex={100}
    >
      <button
        id="prompt-buddy-icon"
        role="button"
        aria-label="Prompt Buddy Helper"
        onClick={handleClick}
      >
        <IconSvg />
      </button>
...
export default PromptBuddyIcon;
